...
public partial class ChatBotIaCoreContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=localhost,1433;Initial Catalog=ChatBotDb;User ID=sa;Password=DevDbSecure123!;Encrypt=False;Trust Server Certificate=True");
